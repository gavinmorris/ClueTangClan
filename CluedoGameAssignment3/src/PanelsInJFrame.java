...
public class PanelsInJFrame {
	...
	public PanelsInJFrame() {
		...
		textualcommand.button.addActionListener(new SendMessageButtonListener(board, display, textualcommand, boardstructure, notes));
