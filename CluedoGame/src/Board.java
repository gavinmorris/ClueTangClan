...
public class Board extends JPanel {
	...
	static int greenx = 250;
	static int greeny = 25;
	static int mustardx = 44;
	static int mustardy = 415;
	static int peacockx = 572;
	static int peacocky = 161;
	static int plumx = 572;
	static int plumy = 461;
	static int scarlettx = 204;
	static int scarletty = 576;
	static int whitex = 365;
	static int whitey = 25;

	// declare location within rooms for weapons to go to
	static int kitchenx = 65;
	static int kitcheny = 44;
	static int ballroomx = 300;
	static int ballroomy = 44;
	static int conservatoryx = 555;
	static int conservatoryy = 44;
	static int billiardroomx = 555;
	static int billiardroomy = 260;
	static int libraryx = 555;
	static int libraryy = 374;
	static int studyx = 445;
	static int studyy = 511;
	static int hallx = 300;
	static int hally = 540;
	static int loungex = 155;
	static int loungey = 500;
	static int diningroomx = 170;
	static int diningroomy = 285;

	public JLayeredPane layeredPane;

	public Board() {

		// assign each image icon its corresponding image and assign each jlabel its
		...
		// set jlayeredpane background to cluedo board and set the pieces and weapons to
		...
		candlestickLabel.setBounds(kitchenx, kitcheny, candlestickImage.getIconWidth(),
				candlestickImage.getIconHeight());
