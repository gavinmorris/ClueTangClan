...
public class Board extends JPanel {
	...
	public Board() {
		...
		for(int i = 0;i<tokenAL.size();i++) {
			...
			else if(tokenAL.get(i).name.equals("Mustard")) {
			...
			else if(tokenAL.get(i).name.equals("Peacock")) {
			...
			else if(tokenAL.get(i).name.equals("Plum")) {
			...
			else if(tokenAL.get(i).name.equals("Scarlett")) {
